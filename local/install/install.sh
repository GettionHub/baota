...
Install_Bt(){
	...
	cp -f /local/install/src/bt6.init /etc/init.d/bt
	cp -f /local/install/src/public.sh /www/server/panel/install/public.sh
	cp -f /local/install/src/panel6.zip panel.zip
	...
	cp -f /local/install/src/bt7.init /etc/init.d/bt
	cp -f /local/install/src/bt7.init /www/server/panel/init.sh
	cp -f /local/install/conf/softList.conf /www/server/panel/data/softList.conf
}
Set_Bt_Panel(){
